...
template<class XXX> template<class Rep, class Period> bool xPriorityQueue<XXX>::EnqueueWaitFor(XXX Data, const std::chrono::duration<Rep, Period>& Duration)
{
...
template<class XXX> template<class Rep, class Period> bool xPriorityQueue<XXX>::DequeueWaitFor(XXX& Data, const std::chrono::duration<Rep, Period>& Duration)
{
...
template<class XXX> template<class Clock, class Duration> bool xPriorityQueue<XXX>::EnqueueWaitUntil(XXX Data, const std::chrono::time_point<Clock, Duration>& TimePoint)
{
...
template<class XXX> template<class Clock, class Duration> bool xPriorityQueue<XXX>::DequeueWaitUntil(XXX& Data, const std::chrono::time_point<Clock, Duration>& TimePoint)
{
  if(TimePoint == std::chrono::time_point<Clock, Duration>::max()) { DequeueWait(Data); return true; } //fir for some broken implementations (i.e. MSVC 14)
